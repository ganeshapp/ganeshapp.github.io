...
[I stopped hitting Claude's usage limits – things I changed](https://twitter.com/0x_kaize/status/2038286026284667239){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47658164){:target="_blank"}

[Google releases Gemma 4 open models](https://deepmind.google/models/gemma/gemma-4/){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47616361){:target="_blank"}

[The threat is comfortable drift toward not understanding what you're doing](https://ergosphere.blog/posts/the-machines-are-fine/){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47647788){:target="_blank"}

[Show HN: I just built a MCP Server that connects Claude to all your wearables](https://pacetraining.co/){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47658617){:target="_blank"}

[Show HN: Modo – I built an open-source alternative to Kiro, Cursor, and Windsurf](https://github.com/mohshomis/modo){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47655268){:target="_blank"}

[Show HN: Gemma Gem – AI model embedded in a browser – no API keys, no cloud](https://github.com/kessler/gemma-gem){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47655367){:target="_blank"}

[Music for Programming](https://musicforprogramming.net){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47652322){:target="_blank"}

[Running Gemma 4 locally with LM Studio's new headless CLI and Claude Code](https://ai.georgeliu.com/p/running-google-gemma-4-locally-with){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47651540){:target="_blank"}

[Signals, the push-pull based algorithm](https://willybrauner.com/journal/signal-the-push-pull-based-algorithm){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47637116){:target="_blank"}

[Show HN: Real-time AI (audio/video in, voice out) on an M3 Pro with Gemma E2B](https://github.com/fikrikarim/parlor){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47652007){:target="_blank"}

[Gemma 4 on iPhone](https://apps.apple.com/nl/app/google-ai-edge-gallery/id6749645337){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47652561){:target="_blank"}

[Show HN: I built a tiny LLM to demystify how language models work](https://github.com/arman-bd/guppylm){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47655408){:target="_blank"}

[OpenScreen is an open-source alternative to Screen Studio](https://github.com/siddharthvaddem/openscreen){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47595695){:target="_blank"}

[Shooting down ideas is not a skill](https://scottlawsonbc.com/post/shooting-down-ideas){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47645037){:target="_blank"}

[LLM Wiki – example of an "idea file"](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47640875){:target="_blank"}

[Show HN: A game where you build a GPU](https://jaso1024.com/mvidia/){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47640728){:target="_blank"}

[The Claude Code Source Leak: fake tools, frustration regexes, undercover mode](https://alex000kim.com/posts/2026-03-31-claude-code-source-leak/){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47586778){:target="_blank"}

[Show HN: Yoink – Spotify to lossless with full metadata, self-hostable, ad-free](https://yoinkify.com){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47521910){:target="_blank"}

[Show HN: ProofShot – Give AI coding agents eyes to verify the UI they build](https://github.com/AmElmo/proofshot){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47499672){:target="_blank"}

[The risk of AI isn't making us lazy, but making "lazy" look productive](#){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47555081){:target="_blank"}

[Ask HN: Founders of estonian e-businesses – is it worth it?](#){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47500239){:target="_blank"}

[Algorithm Visualizer](https://algorithm-visualizer.org/){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47463548){:target="_blank"}

[Overcoming the friendship recession](https://joeprevite.com/friendship-recession/){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47453737){:target="_blank"}

[Nvidia NemoClaw](https://github.com/NVIDIA/NemoClaw){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47427027){:target="_blank"}

[Unsloth Studio](https://unsloth.ai/docs/new/studio){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47414032){:target="_blank"}

[Ask HN: Most beautiful personal blog UI you have ever seen?](#){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47302553){:target="_blank"}

[Ask HN: What Are You Working On? (March 2026)](#){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47303111){:target="_blank"}

[Create value for others and don’t worry about the returns](https://geohot.github.io//blog/jekyll/update/2026/03/11/running-69-agents.html){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47332074){:target="_blank"}

[Tell HN: I'm 60 years old. Claude Code has re-ignited a passion](#){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47282777){:target="_blank"}

[Show HN: 1v1 coding game that LLMs struggle with](https://yare.io){:target="_blank"} [<i class="fab fa-fw fa-hacker-news"></i>](https://news.ycombinator.com/item?id=47271751){:target="_blank"}
